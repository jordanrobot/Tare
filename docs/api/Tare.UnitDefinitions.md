...
| Methods | |
| :--- | :--- |
| [GetUnitsForType(UnitTypeEnum)](Tare.UnitDefinitions.GetUnitsForType(Tare.UnitTypeEnum).md 'Tare.UnitDefinitions.GetUnitsForType(Tare.UnitTypeEnum)') | Gets a list of all catalog unit definitions for a specified dimension type.<br/>Useful for unit discovery and populating UI dropdowns. |
