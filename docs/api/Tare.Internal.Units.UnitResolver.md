...
| [Resolve(string)](Tare.Internal.Units.UnitResolver.Resolve(string).md 'Tare.Internal.Units.UnitResolver.Resolve(string)') | Resolves a unit to its normalized representation with base conversion factor. |
