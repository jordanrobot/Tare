...
| [ComputeFactorToBaseRational(UnitToken, UnitToken, UnitDefinition)](Tare.Internal.Units.UnitResolver.ComputeFactorToBaseRational(Tare.Internal.Units.UnitToken,Tare.Internal.Units.UnitToken,Tare.UnitDefinition).md 'Tare.Internal.Units.UnitResolver.ComputeFactorToBaseRational(Tare.Internal.Units.UnitToken, Tare.Internal.Units.UnitToken, Tare.UnitDefinition)') | Computes the conversion factor from a unit to the base unit of its dimension (exact rational). |
