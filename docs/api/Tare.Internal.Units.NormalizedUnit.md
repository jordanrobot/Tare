...
| Constructors | |
| :--- | :--- |
| [NormalizedUnit(UnitToken, decimal, UnitTypeEnum, DimensionSignature)](Tare.Internal.Units.NormalizedUnit.NormalizedUnit(Tare.Internal.Units.UnitToken,decimal,Tare.UnitTypeEnum,Tare.Internal.Units.DimensionSignature).md 'Tare.Internal.Units.NormalizedUnit.NormalizedUnit(Tare.Internal.Units.UnitToken, decimal, Tare.UnitTypeEnum, Tare.Internal.Units.DimensionSignature)') | Constructs a normalized unit with decimal factor (converted to rational). |
| [NormalizedUnit(UnitToken, Rational, UnitTypeEnum, DimensionSignature)](Tare.Internal.Units.NormalizedUnit.NormalizedUnit(Tare.Internal.Units.UnitToken,Tare.Internal.Rational,Tare.UnitTypeEnum,Tare.Internal.Units.DimensionSignature).md 'Tare.Internal.Units.NormalizedUnit.NormalizedUnit(Tare.Internal.Units.UnitToken, Tare.Internal.Rational, Tare.UnitTypeEnum, Tare.Internal.Units.DimensionSignature)') | Constructs a normalized unit with exact rational factor. |
...
| [FactorToBaseRational](Tare.Internal.Units.NormalizedUnit.FactorToBaseRational.md 'Tare.Internal.Units.NormalizedUnit.FactorToBaseRational') | Gets the exact conversion factor to the dimension's base unit. |
